  ...
  static double getEffectiveness(
    ...
    switch (moveType) {
      case ElementalType.electric:
        ...
        if (defenderType == ElementalType.burrowing) return 0;
        break;
      case ElementalType.rock:
        if (defenderType == ElementalType.flying) return 2.0;
        if (defenderType == ElementalType.tiny) return 2.0;
      ...
      case ElementalType.flying:
        ...
        if (defenderType == ElementalType.arthropod) return 2.0;
        if (defenderType == ElementalType.arboreal) return 2.0;
      ...
      case ElementalType.armored:
        ...
        if (defenderType == ElementalType.venomous)
          return 2.0; // Fangs can't pierce? Actually Venomous > Armored usually false.
      ...
      case ElementalType.venomous:
        if (defenderType == ElementalType.giant)
          return 2.0; // Big target, potent toxin
